...
<style>
  :root{--pink:#ea526f;--black:#070600;--ghost:#f7f7ff;--surf:#23b5d3;--blue:#279af1}
  *{box-sizing:border-box}html,body{min-height:100%}body{margin:0;background:var(--ghost);color:var(--black);font:15px/1.5 Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;-webkit-font-smoothing:antialiased}
  .auth-shell{min-height:100vh;display:grid;grid-template-columns:minmax(0,1.08fr) minmax(420px,.92fr);padding:18px;gap:18px}
  .visual{position:relative;overflow:hidden;min-height:calc(100vh - 36px);padding:46px;border-radius:30px;color:var(--ghost);background:radial-gradient(circle at 24% 18%,rgba(35,181,211,.34),transparent 20rem),radial-gradient(circle at 85% 85%,rgba(234,82,111,.28),transparent 23rem),var(--black)}
  .visual:before{content:"";position:absolute;inset:0;background-image:linear-gradient(rgba(247,247,255,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(247,247,255,.045) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(135deg,#000,transparent 72%)}
  .brand{position:relative;z-index:2;display:flex;align-items:center;gap:12px;font-weight:800;letter-spacing:-.02em}.mark{width:42px;height:42px;display:grid;place-items:center;border-radius:14px;background:linear-gradient(135deg,var(--surf),var(--blue) 48%,var(--pink));box-shadow:0 12px 30px rgba(39,154,241,.28)}.brand small{display:block;margin-top:1px;color:rgba(247,247,255,.5);font-size:9px;letter-spacing:.16em}
  .story{position:relative;z-index:2;max-width:720px;margin-top:clamp(90px,17vh,190px)}.kicker{color:var(--surf);font-size:10px;font-weight:850;letter-spacing:.16em;text-transform:uppercase}.story h1{max-width:680px;margin:14px 0 22px;font-size:clamp(48px,6vw,88px);line-height:.94;letter-spacing:-.065em}.story p{max-width:560px;margin:0;color:rgba(247,247,255,.62);font-size:16px}
  .capabilities{position:absolute;z-index:2;left:46px;right:46px;bottom:42px;display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid rgba(247,247,255,.14)}.capability{display:grid;grid-template-columns:auto 1fr;column-gap:13px;padding:20px 24px 0 0}.capability+.capability{padding-left:24px;border-left:1px solid rgba(247,247,255,.1)}.capability span{grid-row:1/3;color:var(--surf);font-size:10px;font-weight:800;letter-spacing:.08em}.capability strong{font-size:13px}.capability p{margin:3px 0 0;color:rgba(247,247,255,.42);font-size:10px}
  ...
  .login h2{margin:0 0 8px;font-size:36px;line-height:1.1;letter-spacing:-.045em}.login>p{margin:0 0 30px;color:#66717a}.field{display:grid;gap:8px}.field label{font-size:11px;font-weight:750}.input-wrap{position:relative}.input-wrap svg{position:absolute;left:15px;top:15px;color:#8d98a0}.input-wrap input{width:100%;height:52px;border:1px solid rgba(7,6,0,.14);border-radius:14px;padding:0 15px 0 45px;background:#fff;color:var(--black);font-size:15px;outline:none;box-shadow:0 10px 26px rgba(7,6,0,.04);transition:.18s ease}.input-wrap input:focus{border-color:var(--blue);box-shadow:0 0 0 4px rgba(39,154,241,.13),0 12px 30px rgba(7,6,0,.06)}
  ...
  @media(max-width:900px){.auth-shell{grid-template-columns:1fr;padding:10px}.visual{min-height:430px;padding:28px}.story{max-width:720px;margin-top:58px}.story h1{font-size:50px}.story p{font-size:13px}.capabilities{left:28px;right:28px;bottom:28px}.panel{padding:42px 24px 54px}}
  @media(max-width:540px){.visual{min-height:390px;border-radius:22px}.story{margin-top:48px}.story h1{font-size:40px}.story p{max-width:94%}.capabilities{grid-template-columns:1fr;gap:0}.capability{padding:10px 0}.capability+.capability{padding-left:0;border-left:0;border-top:1px solid rgba(247,247,255,.08)}.capability p{display:none}.panel{padding:34px 14px 46px}.login h2{font-size:31px}}
